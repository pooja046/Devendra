...
public class SessionManager {
    ...
    private static final String OFF_LINE_KEY_ITEM = "off_line_key_item";
    ...
    public void setKeyItemsOffLineData(
            HashMap<String, String> offLineData) {
        Gson gson = new Gson();
        String vOffLineData = gson.toJson(offLineData);
        editor_globel.putString(OFF_LINE_KEY_ITEM, vOffLineData);
        editor_globel.commit();
    }

    public HashMap<String, String> getKeyItemsOffLineData() {
        Gson gson = new Gson();
        String vjson = pref_globel.getString(OFF_LINE_KEY_ITEM, "");
        java.lang.reflect.Type listType = new TypeToken<HashMap<String, String>>() {
        }.getType();
        HashMap<String, String> offLineData = (HashMap<String, String>) gson.fromJson(
                vjson, listType);
        return offLineData;
    }
    ...
    public int isNotificationCount() {
