...
public class CustomExpandAdapter extends BaseExpandableListAdapter {
	...
	public CustomExpandAdapter(Activity context, List<SampleTO> parentList,
	...
	public String getChild(int groupPosition, int childPosition) {
		return this.childRecord.get(getGroup(groupPosition).getTitle()).get(
				childPosition);
	}
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.custom_list_view_child,
					null);
