 ...
 */
public class ImageGalleryProductAdapter extends PagerAdapter {
	private Context context;
	private LayoutInflater inflater;
	private ArrayList<SliderDTO> sliderDTOs;
	private DisplayImageOptions options;

	public ImageGalleryProductAdapter(Context context,
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		...
		club_image.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*
				 * try { if (HomeFragment.homeFragment != null) {
				 * HomeFragment.homeFragment
				 * .openGridfromSliderItemClick(position); } } catch (Exception
				 * e) {
				 * 
				 * }
				 */
